...
exports.BridgeMainnet = void 0;
const networks_1 = require("../../common/networks/networks");
exports.BridgeMainnet = {
    name: "mainnet",
    algorand: {
        name: "mainnet",
    ...
    evm: {
        [networks_1.BridgeNetworks.Avalanche]: {
            chainId: 43114,
            bridge: "",
            rpcUrl: "",
            tokens: [],
        ...
        [networks_1.BridgeNetworks.Ethereum]: {
            chainId: 1,
            bridge: "",
            rpcUrl: "",
            tokens: [],
        ...
        [networks_1.BridgeNetworks.Polygon]: {
            chainId: 137,
            bridge: "",
            rpcUrl: "",
            tokens: [],
