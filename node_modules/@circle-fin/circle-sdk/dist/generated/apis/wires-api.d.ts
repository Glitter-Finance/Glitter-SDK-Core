...
export declare const WiresApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createWireAccount: (wireCreationRequest?: WireCreationRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getWireAccount: (id: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * Get the wire transfer instructions into the Circle bank account given your bank account id
     * @summary Get Wire instructions
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @throws {RequiredError}
     */
    getWireAccountInstructions: (id: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
...
export declare const WiresApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createWireAccount(wireCreationRequest?: WireCreationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateWireAccountResponse>>;
    /**
     *
     * @summary Get a Wire bank account
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @throws {RequiredError}
     */
    getWireAccount(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetWireAccountResponse>>;
    /**
     * Get the wire transfer instructions into the Circle bank account given your bank account id
     * @summary Get Wire instructions
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @throws {RequiredError}
     */
    getWireAccountInstructions(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetWireAccountInstructionsResponse>>;
    /**
     *
     * @summary List all Wire bank accounts
     * @param {*} [options] Override http request option.
...
export declare const WiresApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    createWireAccount(wireCreationRequest?: WireCreationRequest, options?: any): AxiosPromise<CreateWireAccountResponse>;
    /**
     *
     * @summary Get a Wire bank account
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @throws {RequiredError}
     */
    getWireAccount(id: string, options?: any): AxiosPromise<GetWireAccountResponse>;
    /**
     * Get the wire transfer instructions into the Circle bank account given your bank account id
     * @summary Get Wire instructions
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @throws {RequiredError}
     */
    getWireAccountInstructions(id: string, options?: any): AxiosPromise<GetWireAccountInstructionsResponse>;
    /**
     *
     * @summary List all Wire bank accounts
     * @param {*} [options] Override http request option.
...
export declare class WiresApi extends BaseAPI {
     ...
     * @memberof WiresApi
     */
    createBusinessWireAccount(wireCreationRequest?: WireCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateBusinessWireAccountResponse>>;
    /**
     *
     * @summary Create a Wire bank account
     * @param {WireCreationRequest} [wireCreationRequest]
     ...
     * @memberof WiresApi
     */
    createWireAccount(wireCreationRequest?: WireCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateWireAccountResponse>>;
    /**
     *
     * @summary Get a Wire bank account
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof WiresApi
     */
    getBusinessWireAccount(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetBusinessWireAccountResponse>>;
    /**
     * Get the wire transfer instructions into the Circle bank account given your bank account id.
     * @summary Get Wire instructions
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof WiresApi
     */
    getBusinessWireAccountInstructions(id: string, currency?: "USD" | "EUR", options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetBusinessWireAccountInstructionsResponse>>;
    /**
     *
     * @summary Get a Wire bank account
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof WiresApi
     */
    getWireAccount(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetWireAccountResponse>>;
    /**
     * Get the wire transfer instructions into the Circle bank account given your bank account id
     * @summary Get Wire instructions
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof WiresApi
     */
    getWireAccountInstructions(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetWireAccountInstructionsResponse>>;
    /**
     *
     * @summary List all Wire bank accounts
     * @param {*} [options] Override http request option.
     ...
     * @memberof WiresApi
     */
    listBusinessWireAccounts(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListBusinessWireAccountsResponse>>;
}
