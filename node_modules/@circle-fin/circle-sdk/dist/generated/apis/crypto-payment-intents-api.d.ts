...
export declare const CryptoPaymentIntentsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    createPaymentIntent: (paymentIntentCreationRequest?: PaymentIntentCreationRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
...
export declare const CryptoPaymentIntentsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createPaymentIntent(paymentIntentCreationRequest?: PaymentIntentCreationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatePaymentIntentResponse>>;
    /**
     *
     * @summary Expire a payment intent
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
...
export declare const CryptoPaymentIntentsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    createPaymentIntent(paymentIntentCreationRequest?: PaymentIntentCreationRequest, options?: any): AxiosPromise<CreatePaymentIntentResponse>;
    /**
     *
     * @summary Expire a payment intent
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
...
export declare class CryptoPaymentIntentsApi extends BaseAPI {
     ...
     */
    createPaymentIntent(paymentIntentCreationRequest?: PaymentIntentCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreatePaymentIntentResponse>>;
    /**
     *
     * @summary Expire a payment intent
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CryptoPaymentIntentsApi
     */
    expirePaymentIntent(id: string, body?: object, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ExpirePaymentIntentResponse>>;
    /**
     *
     * @summary Get a payment intent
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CryptoPaymentIntentsApi
     */
    getPaymentIntent(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetPaymentIntentResponse>>;
    /**
     *
     * @summary List all payment intents
     * @param {'created' | 'pending' | 'complete' | 'expired' | 'failed'} [status] Filters by the most recent &#x60;timeline.status&#x60; within the payment intent.
     ...
     * @memberof CryptoPaymentIntentsApi
     */
    listPaymentIntents(status?: "created" | "pending" | "complete" | "expired" | "failed", context?: "underpaid" | "paid" | "overpaid", from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListPaymentIntentsResponse>>;
    /**
     *
     * @summary Refund a payment intent
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CryptoPaymentIntentsApi
     */
    refundPaymentIntent(id: string, cryptoRefundCreationRequest?: CryptoRefundCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateCryptoRefundResponse>>;
}
