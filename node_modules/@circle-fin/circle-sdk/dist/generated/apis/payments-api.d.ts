...
export declare const PaymentsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createMockSepaPayment: (mockSepaPaymentRequest?: MockSepaPaymentRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listPayments: (source?: string, settlementId?: string, paymentIntentId?: string, type?: Set<"card" | "wire" | "ach" | "sepa">, status?: "pending" | "confirmed" | "paid" | "failed" | "action_required", from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const PaymentsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createMockSepaPayment(mockSepaPaymentRequest?: MockSepaPaymentRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateSepaPaymentResponse>>;
    /**
     * In the sandbox environment, initiate a mock wire payment that mimics the behavior of funds sent through the bank (wire) account linked to master wallet.
     * @summary Create a mock Wire payment
     * @param {MockWirePaymentRequest} [mockWirePaymentRequest]
     ...
     * @throws {RequiredError}
     */
    listPayments(source?: string, settlementId?: string, paymentIntentId?: string, type?: Set<"card" | "wire" | "ach" | "sepa">, status?: "pending" | "confirmed" | "paid" | "failed" | "action_required", from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListPaymentsResponse>>;
    /**
     * The payment source will be refunded if possible. Not all payments are eligible to be cancelled.  A successful response does *not* mean the payment has been refunded; it only means the refund request is successfully submitted.
     * @summary Refund a payment
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
...
export declare const PaymentsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    createMockSepaPayment(mockSepaPaymentRequest?: MockSepaPaymentRequest, options?: any): AxiosPromise<CreateSepaPaymentResponse>;
    /**
     * In the sandbox environment, initiate a mock wire payment that mimics the behavior of funds sent through the bank (wire) account linked to master wallet.
     * @summary Create a mock Wire payment
     * @param {MockWirePaymentRequest} [mockWirePaymentRequest]
     ...
     * @throws {RequiredError}
     */
    listPayments(source?: string, settlementId?: string, paymentIntentId?: string, type?: Set<"card" | "wire" | "ach" | "sepa">, status?: "pending" | "confirmed" | "paid" | "failed" | "action_required", from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: any): AxiosPromise<ListPaymentsResponse>;
    /**
     * The payment source will be refunded if possible. Not all payments are eligible to be cancelled.  A successful response does *not* mean the payment has been refunded; it only means the refund request is successfully submitted.
     * @summary Refund a payment
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
...
export declare class PaymentsApi extends BaseAPI {
     ...
     */
    cancelPayment(id: string, cancelCreationRequest?: CancelCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CancelPaymentResponse>>;
    /**
     * Warning: Please contact Circle support if you are planning on using this feature.  The given amount will be captured for the authorized payment if possible. If no amount is specified, the full amount will be captured. You can only capture once per authorization.  A successful response does *not* mean the payment has been captured. It only means the capture request was successfully submitted.
     * @summary Capture a payment (BETA)
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof PaymentsApi
     */
    capturePayment(id: string, captureCreationRequest?: CaptureCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * In the sandbox environment, initiate a mock SEPA payment that mimics the behavior of funds sent through the bank (SEPA) account linked to master wallet.
     * @summary Create a mock SEPA payment
     * @param {MockSepaPaymentRequest} [mockSepaPaymentRequest]
     ...
     * @memberof PaymentsApi
     */
    createMockSepaPayment(mockSepaPaymentRequest?: MockSepaPaymentRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateSepaPaymentResponse>>;
    /**
     * In the sandbox environment, initiate a mock wire payment that mimics the behavior of funds sent through the bank (wire) account linked to master wallet.
     * @summary Create a mock Wire payment
     * @param {MockWirePaymentRequest} [mockWirePaymentRequest]
     ...
     * @memberof PaymentsApi
     */
    createMockWirePayment(mockWirePaymentRequest?: MockWirePaymentRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateWirePaymentResponse>>;
    /**
     *
     * @summary Create a payment
     * @param {PaymentCreationRequest} [paymentCreationRequest]
     ...
     * @memberof PaymentsApi
     */
    createPayment(paymentCreationRequest?: PaymentCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreatePaymentResponse>>;
    /**
     *
     * @summary Get a payment
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof PaymentsApi
     */
    getPayment(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetPaymentResponse>>;
    /**
     *
     * @summary List all payments
     * @param {string} [source] Universally unique identifier (UUID v4) for the source. Filters results to fetch only payments made from the provdided source.
     ...
     * @memberof PaymentsApi
     */
    listPayments(source?: string, settlementId?: string, paymentIntentId?: string, type?: Set<"card" | "wire" | "ach" | "sepa">, status?: "pending" | "confirmed" | "paid" | "failed" | "action_required", from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListPaymentsResponse>>;
    /**
     * The payment source will be refunded if possible. Not all payments are eligible to be cancelled.  A successful response does *not* mean the payment has been refunded; it only means the refund request is successfully submitted.
     * @summary Refund a payment
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof PaymentsApi
     */
    refundPayment(id: string, refundCreationRequest?: RefundCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<RefundPaymentResponse>>;
}
