...
export declare const PayoutsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createPayout: (createPayoutRequest?: CreatePayoutRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    listBusinessPayouts: (destination?: string, type?: "wire", status?: Set<PayoutStatus>, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     * @summary List all payouts
...
export declare const PayoutsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createPayout(createPayoutRequest?: CreatePayoutRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatePayoutResponse>>;
    /**
     *
     * @summary Get a payout
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @throws {RequiredError}
     */
    listBusinessPayouts(destination?: string, type?: "wire", status?: Set<PayoutStatus>, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListBusinessPayoutsResponse>>;
    /**
     *
     * @summary List all payouts
     * @param {string} [source] Identifier for the source wallet. Filters the fetched payout results to only be from a specific source wallet. If not provided, payouts from all wallets will be returned.
     ...
     * @throws {RequiredError}
     */
    listPayouts(source?: string, destination?: string, type?: Set<PayoutDestinationType>, status?: Set<PayoutStatus>, sourceCurrency?: "USD" | "EUR" | "BTC" | "ETH" | "MTC" | "FLW" | "MAN", destinationCurrency?: "USD" | "EUR" | "BTC" | "ETH" | "MTC" | "FLW" | "MAN", chain?: "ALGO" | "AVAX" | "BTC" | "ETH" | "FLOW" | "HBAR" | "MATIC" | "SOL" | "TRX" | "XLM", from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListPayoutsResponse>>;
};
/**
...
export declare const PayoutsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    createPayout(createPayoutRequest?: CreatePayoutRequest, options?: any): AxiosPromise<CreatePayoutResponse>;
    /**
     *
     * @summary Get a payout
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @throws {RequiredError}
     */
    listBusinessPayouts(destination?: string, type?: "wire", status?: Set<PayoutStatus>, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: any): AxiosPromise<ListBusinessPayoutsResponse>;
    /**
     *
     * @summary List all payouts
     * @param {string} [source] Identifier for the source wallet. Filters the fetched payout results to only be from a specific source wallet. If not provided, payouts from all wallets will be returned.
     ...
     * @throws {RequiredError}
     */
    listPayouts(source?: string, destination?: string, type?: Set<PayoutDestinationType>, status?: Set<PayoutStatus>, sourceCurrency?: "USD" | "EUR" | "BTC" | "ETH" | "MTC" | "FLW" | "MAN", destinationCurrency?: "USD" | "EUR" | "BTC" | "ETH" | "MTC" | "FLW" | "MAN", chain?: "ALGO" | "AVAX" | "BTC" | "ETH" | "FLOW" | "HBAR" | "MATIC" | "SOL" | "TRX" | "XLM", from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: any): AxiosPromise<ListPayoutsResponse>;
};
/**
...
export declare class PayoutsApi extends BaseAPI {
     ...
     * @memberof PayoutsApi
     */
    createBusinessPayout(businessPayoutCreationRequest?: BusinessPayoutCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateBusinessPayoutResponse>>;
    /**
     *  Create a wire, ACH, SEPA or crypto payout.    The following table includes the supported pairs of amount.currency and toAmount.currency for address book payouts:  | amount.currency  | toAmount.currency | | ---------------- | ------------      | | USD              | USD               | | USD              | BTC               | | USD              | ETH               | | USD              | MTC               | | EUR              | EUR               | | BTC              | USD               | | BTC              | BTC               | | ETH              | USD               | | ETH              | ETH               |
     * @summary Create a payout
     * @param {CreatePayoutRequest} [createPayoutRequest]
     ...
     * @memberof PayoutsApi
     */
    createPayout(createPayoutRequest?: CreatePayoutRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreatePayoutResponse>>;
    /**
     *
     * @summary Get a payout
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof PayoutsApi
     */
    getBusinessPayout(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetBusinessPayoutResponse>>;
    /**
     *
     * @summary Get a payout
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof PayoutsApi
     */
    getPayout(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetPayoutResponse>>;
    /**
     *
     * @summary List all payouts
     * @param {string} [destination] Universally unique identifier (UUID v4) for the destination bank account. Filters the results to fetch all payouts made to a destination bank account.
     ...
     * @memberof PayoutsApi
     */
    listBusinessPayouts(destination?: string, type?: "wire", status?: Set<PayoutStatus>, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListBusinessPayoutsResponse>>;
    /**
     *
     * @summary List all payouts
     * @param {string} [source] Identifier for the source wallet. Filters the fetched payout results to only be from a specific source wallet. If not provided, payouts from all wallets will be returned.
     ...
     * @memberof PayoutsApi
     */
    listPayouts(source?: string, destination?: string, type?: Set<PayoutDestinationType>, status?: Set<PayoutStatus>, sourceCurrency?: "USD" | "EUR" | "BTC" | "ETH" | "MTC" | "FLW" | "MAN", destinationCurrency?: "USD" | "EUR" | "BTC" | "ETH" | "MTC" | "FLW" | "MAN", chain?: "ALGO" | "AVAX" | "BTC" | "ETH" | "FLOW" | "HBAR" | "MATIC" | "SOL" | "TRX" | "XLM", from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListPayoutsResponse>>;
}
