...
// import {AlgorandAccounts}  from './lib/src/algorand/accounts'
// import {SolanaAccounts} from './lib/src/solana/accounts'
// const {SolanaConnect} = require('./src/solana/index')
import {SolanaConnect} from './src/solana'; 
run()
...
// async function SolanaToUsdc(solana_address)  {
...
async function runMain() {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            console.log("Starting to Balance: ", startingBalance);
